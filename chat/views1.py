...
@swagger_auto_schema(
    method='get',
    operation_description="Get all group conversations the user is a member of, with admin status",
    responses={
        200: openapi.Schema(
            type=openapi.TYPE_OBJECT,
            properties={
...
def get_user_groups(request):
    """
    Get all group conversations the user is a member of, with admin status
    """
